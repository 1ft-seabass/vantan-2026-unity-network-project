...
public class Week03_Chapter02_SendButton_OK_Sample : MonoBehaviour, IPointerClickHandler
{
    ...
    IEnumerator PostPointData()
    {
        ...
        pointRequestData.point = GameObject.Find("ClickPart").GetComponent<Week03_Chapter02_ClickPart>().currentPoint;
